...
const Footer: React.FC = () => {
  return (
    <footer className="bg-primary-600 dark:bg-gradient-to-br dark:from-gray-800 dark:to-gray-900 text-white py-6 mt-16 rounded-t-4xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            <div className="flex items-center mb-4">
              <div className="h-10 w-10 rounded-md bg-white dark:bg-gray-700 flex items-center justify-center">
            ...
            <p className="text-primary-100 dark:text-gray-300 mb-4">
        ...
        <div className="border-t border-primary-600 dark:border-gray-700 mt-6 pt-6 text-center text-primary-100 dark:text-gray-300">
          <p>
